...
#define KSCREEN_WIDTH                       ((UIDevice.currentDevice.userInterfaceIdiom == UIUserInterfaceIdiomPad) ? [UIApplication sharedApplication].delegate.window.bounds.size.width : [UIScreen mainScreen].bounds.size.width)
